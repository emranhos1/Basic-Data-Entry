...
public class Outlet {
    ...
    public String getTrade_licence_photo() {
        return trade_licence_photo;
    }

    public void setTrade_licence_photo(String trade_licence_photo) {
        this.trade_licence_photo = trade_licence_photo;
    }
