...
<html lang="en">
    ...
    <body>
        ...
        <div class="full-page  section-image" data-color="black" data-image="<%=request.getContextPath()%>/static/image/full-screen-image-2.jpg">
            ...
            <div class="content card-hidden" id="kjjh">
                <!--<div class="container">-->
                <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header ">
                                    <div class="card-header text-center">
                                        <h4 class="card-title">Save Outlet Information</h4>
                                    </div>
                                    <div class="card-body ">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <form:textarea type="text" path="business_address" class="form-control" placeholder="business Address"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Trad license</label>
                                                    <form:input type="text" path="trade_licence" class="form-control" placeholder="Trad licence"/>
                                                </div>
                                            </div>
